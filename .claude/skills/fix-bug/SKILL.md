...
- For CLI fixes, do not post Done or hand the ticket to QA until the PR is merged, the `Install fleet CLI` workflow succeeds for the merge commit, and the installed `hypertask` binary passes the production verification.
