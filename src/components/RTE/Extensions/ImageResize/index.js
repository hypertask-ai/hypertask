...
const ImageResize = Image.extend({
    addAttributes() {
        return {
            ...
            style: {
                default: 'cursor: pointer; min-height:180px',
            },
            loading:{
                default:"lazy"
            }
    ...
    addNodeView() {
        return ({ node, editor, getPos }) => {
            ...
            $container.addEventListener('click', () => {
                $container.setAttribute('style', `position: relative; width:fit-content !important; border: 1px dashed #6C6C6C; ${style} cursor: pointer;`);
