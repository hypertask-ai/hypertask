...
const TOOL_BEHAVIOR_BY_NAME: Record<string, ToolBehavior> = {
  ...
  [TOOL_METADATA.ARCHIVE_AGENT.name]: 'destructive',
  ...
  [TOOL_METADATA.LINK_TASKS.name]: 'destructive',
  ...
  [TOOL_METADATA.SWITCH_VIEW.name]: 'destructive',
  ...
  [TOOL_METADATA.MOVE_TASK_BETWEEN_BOARDS.name]: 'destructive',
  [TOOL_METADATA.ASSIGN_USER.name]: 'destructive',
  [TOOL_METADATA.INBOX_LIST.name]: 'read',
  [TOOL_METADATA.INBOX_ARCHIVE.name]: 'destructive',
  [TOOL_METADATA.INBOX_UNARCHIVE.name]: 'destructive',
  [TOOL_METADATA.MOVE_TASK_TO_INBOX.name]: 'destructive',
  [TOOL_METADATA.TIME.name]: 'destructive',
  [TOOL_METADATA.PAUSE_TIMER.name]: 'destructive',
  [TOOL_METADATA.RESUME_TIMER.name]: 'destructive',
