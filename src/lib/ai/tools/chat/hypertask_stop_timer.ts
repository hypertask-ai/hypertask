...
export function createHypertaskStopTimerTool(context: ChatToolContext) {
  const { TOOL_TASK_ID_DESCRIPTION, TimeTrackingDisabledError, resolveTaskForTool, sanitizeForJson, sendStatus, stopTimer, tool, user, withToolErrors, z } = context;
  return tool({
      description:
