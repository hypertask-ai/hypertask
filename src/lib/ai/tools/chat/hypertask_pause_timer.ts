...
export function createHypertaskPauseTimerTool(context: ChatToolContext) {
  const { TOOL_TASK_ID_DESCRIPTION, TimeTrackingDisabledError, pauseTimer, resolveTaskForTool, sanitizeForJson, sendStatus, tool, user, withToolErrors, z } = context;
  return tool({
      description:
