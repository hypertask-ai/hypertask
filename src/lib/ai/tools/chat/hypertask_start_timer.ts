...
export function createHypertaskStartTimerTool(context: ChatToolContext) {
  const { TOOL_TASK_ID_DESCRIPTION, TimeTrackingDisabledError, resolveTaskForTool, sanitizeForJson, sendStatus, startTimer, tool, user, withToolErrors, z } = context;
  return tool({
      description:
