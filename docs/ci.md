...
- The required feature-flag gate also checks component reuse before it evaluates flags. A PR adding a component file or inline menu must list each reused base-branch component under **Components reused**; editing the PR body reruns the check.
